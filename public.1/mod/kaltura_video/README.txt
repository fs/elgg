...
FEATURES:
	...
	- Make a collaborative videos in groups. In a group environment you
	  can start a video, put the level of privacy to allow editing by
	  others users of the group and le the other change you initial
	  video.
	...
	- Widget: This plugin has also a widget to allow you show a list of
	  lastest video in the dashboard.
