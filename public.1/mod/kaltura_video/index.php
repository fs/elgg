...
**/
	...
	// Get the current page's owner
		...
		if ($page_owner === false || is_null($page_owner)) {
			if(!isloggedin()) forward($GLOBAL->wwwroot . 'mod/kaltura_video/everyone.php');
	...
	//set blog title
		...
		$area1 .= elgg_list_entities(array('types' => 'object', 'subtypes' => 'kaltura_video', 'container_guid' => page_owner(), 'limit' => $limit, 'offset' => $offset));
	...
	// Display page
		page_draw(sprintf(elgg_echo('kalturavideo:user'),$page_owner->name),$body);
