...
require_once "mod/googleappslogin/models/OAuth.php";

//$consumer_key = 'elgg.flatsourcing.com';
//$consumer_secret = 'rSc2fNBOauGxgDU8hs3pXb8e';

// CODE FROM http://gdatatips.blogspot.com/search/label/oauth
...
$user= 'admin@elgg.flatsourcing.com';

$url = 'https://www.google.com/accounts/OAuthGetRequestToken';
$parameters = array('max-results' => 10, 'xoauth_requestor_id' => $user);
$request = OAuthRequest::from_consumer_and_token($consumer, NULL, 'POST', $url, $parameters);
$request->sign_request(new OAuthSignatureMethod_RSA_SHA1(), $consumer, NULL);

var_dump($request);



//echo send_request('POST', $url, null, $postData);
