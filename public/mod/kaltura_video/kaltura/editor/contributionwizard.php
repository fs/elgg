...
if($error) {
	...
	//add to the river
	add_to_river('river/object/kaltura_video/create','create',$_SESSION['user']->getGUID(),$ob->getGUID());
	$viewData = array();

	$kcw = get_plugin_setting('defaultkcw',"kaltura_video");
	if($kcw == 'custom') $kcw_uid = get_plugin_setting('custom_kcw',"kaltura_video");
	else {
