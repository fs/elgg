...
if(get_plugin_setting("alloweditor","kaltura_video") == 'no') {
...
if(!$error) {
	try {
		...
		$kse = get_plugin_setting('defaulteditor',"kaltura_video");
		if($kse == 'custom') $kse_uid = get_plugin_setting('custom_kse',"kaltura_video");
		else {
