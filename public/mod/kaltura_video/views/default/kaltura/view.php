...
if ($can_rate && $metadata->kaltura_video_rating_on != 'Off') {
	echo elgg_view('input/form', array('action' => "{$CONFIG->wwwroot}action/kaltura_video/rate", "internalname"=>"form1", "internalid"=>"form1", 'body' => elgg_view("kaltura/view.rate",array('entity' => $ob))));
}
?>
