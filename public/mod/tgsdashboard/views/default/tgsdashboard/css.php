<?php
	...
	/**
	 * Elgg tgsdashboard CSS
	 * 
	 * @package tgsdashboard
...
.following_icon {
	...
	height:40px;
	margin:0 2px 0 2px;
	background: url(<?php echo $vars['url']; ?>mod/tgsdashboard/graphics/follow_icon.png) no-repeat left top;
}
